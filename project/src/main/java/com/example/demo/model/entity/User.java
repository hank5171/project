...
Table name: user
+---------+-----------+-----------+---------+-----------+--------------------+---------------------+---------------------+------------+
| user_id | username  | password  |user_role|  status   |   last_login_time  |     created_at      |     updated_at      | is_deleted | 
+---------+-----------+-----------+---------+-----------+--------------------+---------------------+---------------------+------------+
|    1    |  大家號     |  hash     |    1    |     1     |2025/05/20 14:33:02 | 2025/05/20 14:33:02 | 2025/05/20 14:33:02 |      0     |
+---------+-----------+-----------+---------+-----------+--------------------+---------------------+---------------------+------------+
SQL:
CREATE TABLE `user` (
